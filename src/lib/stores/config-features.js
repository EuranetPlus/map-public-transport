export const config = {
	mapTitle: 'map-public-transport', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-public-transport.vercel.app', // The url provided when deploying the map on Vercel
